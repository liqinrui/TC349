...
// 7 10
    ...
    function myFunction() {
        ...
        //audio
        audio1 = new Audio();
        audio1.src = "audio/eat.wav";
        audio1.load();
        audio2 = new Audio();
        audio2.src = "audio/collide.wav";
        audio2.load();
        audio3 = new Audio();
        audio3.src = "audio/win.wav";
        audio3.load();
    ...
    function drawTile(i, j) {
        ...
        if (tileType == 2) {
        	function drawPattern() {
      		context.fillStyle = context.createPattern(appleImage, "repeat");
      		context.fillRect(x, y, 35, 35);
      		}
      		appleImage.src = "img/apple.png";
      		appleImage.onload = drawPattern;
      }
        if (tileType == 3) {
